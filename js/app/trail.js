...
var home_tour_steps={
    "Steps":[
      ...
      "Selector":"#xx",
      "Title":"Guided Tour",
      "HTMLText":"We have redesigned the look feel of the application to make your life easy. Please continue the tour till the end to explore all the new design. <br/> <ul><li>You can use escape key to exit the tour</li><li>You can use Next and Previous buttons or Keyboard arrow keys to move back and forth in the tour.</li></ul>",
